...
#if UNITY_WEBGL
            // The sample's legacy Wire WebSocket bridge calls an Emscripten API that is
            // unavailable in the Unity 2022 WebGL runtime. GameManager polls instead.
            Debug.Log("[Color Clash] WebGL lobby events use polling instead of Wire WebSocket.");
#else
...
#pragma warning restore 4014
    ...
    public class ServiceRateLimiter
    {
        ...
        public async Task QueueUntilCooldown()
        {
            ...
            // This sample's limiter polls with Task.Delay(10). WebGL does not
            // reliably advance that timer, which prevented any Lobby request from
            // being sent at all. GameManager already prevents duplicate refreshes.
