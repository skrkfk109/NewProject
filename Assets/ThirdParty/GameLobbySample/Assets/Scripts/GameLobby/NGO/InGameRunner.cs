...
namespace LobbyRelaySample.ngo
{
    ...
    public class InGameRunner : NetworkBehaviour
    {
        ...
        {
            // The imported sample keeps its "Waiting for all players" canvas and
            // glyph-game logic alive across a network scene transition. Color Clash
            // does not use that minigame: hide it on every peer, then load battle.
        ...
        {
            // The battle scene owns the active Relay session after this runner changes scenes.
        }
